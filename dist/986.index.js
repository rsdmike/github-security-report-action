...
;// CONCATENATED MODULE: ./node_modules/@puppeteer/browsers/node_modules/wrap-ansi/node_modules/string-width/index.js
...
const wrapWord = (rows, word, columns) => {
	...
	let visible = string_width_stringWidth(stripAnsi(rows.at(-1)));
...
function node_modules_string_width_stringWidth(input, options = {}) {
	...
	for (const {segment} of node_modules_string_width_segmenter.segment(string)) {
